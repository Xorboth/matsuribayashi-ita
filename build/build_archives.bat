...
set higurashiData=HigurashiEp08_Data
...
set assetsLinuxMacOsSteamGogMangaGamer=LinuxMac-Steam-GOG-MG-2017.2.5.languagespecificassets

set output07th=matsuribayashi_ita_07th_mod_installer.7z
set outputWindowsSteamGogMangaGamer=matsuribayashi_ita_windows_steam_gog_mg_%version%.7z
set outputLinuxMacOsSteamGogMangaGamer=matsuribayashi_ita_linux_macos_steam_gog_mg_%version%.7z
